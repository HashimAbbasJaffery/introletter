...
پڑھا، سمجھا اور اتفاق کیا۔
  ...
  <div class="tab profile-tab">
    <p>
    <label for="membership_no">ممبرشپ نمبر: <span style="color:red; width:50px;">&#8727;</span></label>
    <input type="text" id="membership_no" class="form-control" placeholder="ممبرشپ نمبر درج کریں" oninput="this.className = ''" name="membership_no" required>
    </p>
    <p>
    <label for="">سی این آئی سی/پاسپورٹ <span style="color:red; width:50px;">&#8727;</span></label>
    <input type="text" id="cnic_passport" class="form-control" placeholder="شناختی کارڈ نمبر XXXXX-XXXXXXX-X کے فارمیٹ میں یا پاسپورٹ نمبر درج کریں۔" oninput="this.className = ''" name="cnic_passport" required>
    </p>
    <p>
    <label for="members_name">ممبر کا نام: <span style="color:red; width:50px;">&#8727;</span></label>
    <input type="text" id="members_name" class="form-control" placeholder="اپنا نام درج کریں..." oninput="this.className = ''" name="full_name" readonly>
    </p>
    ...
    <div class="col-md-12 text-center">
        <button type="button" id="prevBtn" onclick="nextPrev(-1)">پچھلا</button>
        <button type="button" id="nextBtn" onclick="nextPrev(1)">اگلا</button>
    </div>
</div>
   ...
   <p>
        <label for="">بیوی کو شامل کریں <span style='color:red; width:50px;'>&#8727;</span></label>  
...
<div class="mb-3">
  <label for="country-select">مملکت منتخب کریں <span style="color:red;">&#8727;</span></label>
  <select id="country-select" class="form-select" style="width: 100%;"></select>
</div>

<div class="mb-3">
  <label for="city-select">شہر منتخب کریں <span style="color:red;">&#8727;</span></label>
  <select id="city-select" class="form-select" style="width: 100%;" disabled></select>
</div>

<div class="mb-3">
  <label for="club-select">کلب منتخب کریں <span style="color:red;">&#8727;</span></label>
  <select id="club-select" class="form-select" style="width: 100%;" disabled></select>
</div>


  <!-- Inputs to display selected data -->
...
<div class="tab profile-tab">
  <p>
        <label for="duration">مدت <span style='color:red; width:50px;'>&#8727;</span></label>
        <select name="duration" id="duration" style="width:100%; border: 1px solid #aaaaaa; padding: 10px;" required>
            ...
            if ($resultDuration && mysqli_num_rows($resultDuration) > 0) {
                ...
                echo "<option value='' disabled>کوئی آپشن دستیاب نہیں ہے</option>";
            }
            ?>
        </select>
   ...
   <input type='date' placeholder="کلب کا نام" oninput="this.className = ''" name="issue" required>
  ...
  <div class="col-md-12 text-center">
    <button type="button" id="prevBtn" onclick="nextPrev(-1)">پچھلا</button>
    <button type="submit" id="nextBtn">جمع کرائیں</button>
  </div>
</div>
